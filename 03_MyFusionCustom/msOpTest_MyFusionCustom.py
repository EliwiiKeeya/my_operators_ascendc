...
class MyFusionCustomNet(Cell):
    def __init__(self, func, out_shape):
        super(MyFusionCustomNet, self).__init__()
        reg_info = CustomRegOp("MyFusionCustom") \
            .input(0, "a", "required") \
            .input(1, "b", "required") \
            .output(0, "c", "required") \
...
net = MyFusionCustomNet("MyFusionCustom", MyFusionCustomNet.infer_shape)
